...
class offerDrawTest extends TestCase {
    ...
    public function testStateChangesIfPlaying(){
        ...
        $gm->suggestDraw("abc", 1);

        $this->assertEquals(2, count($game->gameInfo->players));
        $this->assertEquals(PlayerStatuses::suggestingDraw, $game->gameInfo->players[0]->currentStatus);
        $this->assertEquals(PlayerStatuses::resolvingDrawOffer, $game->gameInfo->players[1]->currentStatus);
    }
